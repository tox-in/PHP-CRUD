     ...
     <div class="container">
        ...
        <div class="container d-flex justify-content-center">
            ...
            <div class="column">
                    ...
                    <input type="text" class="form-control" name="last_name" placeholder="Einstein" value="<?php echo $row['last_name']?>">
                </div>
                </div>
                <div class="mb-3">
                <label for="form-label">Email:</label>
                    <input type="text" class="form-control" name="email" placeholder="aeinstein@gmail.com"  value="<?php echo $row['email']?>">
                </div>
